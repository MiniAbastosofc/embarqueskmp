...
import org.example.project.ui.home.tabs.rutas.components.CapturedImagePreview
import org.example.project.ui.home.tabs.sucursales.SucursalesState
import org.example.project.ui.home.tabs.sucursales.SucursalesViewModel
import org.koin.compose.viewmodel.koinViewModel

@Composable
fun CapturaSucursales(
    navController: NavHostController,
    sucursalesViewModel: SucursalesViewModel = koinViewModel()
) {
        ...
        when (estadoActual) {
            1 -> {   // SIN INICIAR
                Button(
                    onClick = {
                        val embarqueID = 0
                        val usuarioID = 1 // Tu UserID real
                ...
                Card(
                    ...
                    Column(
                        ...
                        if (showPreview && state.imagenUri != null) {
                            ...
                            // Mostrar la cámara
                            CameraView { path ->
                                sucursalesViewModel.onImagenCapturada(path)
                                showPreview = true
                            }
                        }
                    }
                        ...
                        Column(
                            ...
                            Slider(
                                ...
                                onValueChange = { newValue ->
                                    sucursalesViewModel.setProgress(newValue.toInt())
                                },
                                valueRange = 0f..100f,
                                steps = 99,
                                modifier = Modifier
                    ...
                    Card(
                        ...
                        Column(modifier = Modifier.padding(16.dp)) {
                            ...
                            TextField(
                                ...
                                onValueChange = { sucursalesViewModel.onComentarioChange(it) },
                    ...
                    Row(
                        ...
                        Button(
                            onClick = {
                                // Acción de enviar
                                val embarqueID = 2
                                val usuarioID = 1 // Tu usuario ID real
...
//                                    )
                                    ...
                                    // También puedes mantener los prints para debug
                ...
                if (showConfirmDialog) {
                    AlertDialog(
                        ...
                        confirmButton = {
                            Button(
                                onClick = {
//                                    rutasViewModel.finalizarEmbarque()
